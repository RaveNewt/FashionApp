...
public class TinyDB {
    ...
    public ArrayList<FashionDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<FashionDomain> playerList =  new ArrayList<FashionDomain>();

        for(String jObjString : objStrings){
            FashionDomain player  = gson.fromJson(jObjString,  FashionDomain.class);
    ...
    public void putListObject(String key, ArrayList<FashionDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(FashionDomain player: playerList){
